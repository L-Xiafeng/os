...
static void intr_keyboard_handler(void){
    ...
    * 所以马上结束此次中断处理函数,等待下一个扫描码进来*/ 
    ...
    /* 若为通码,只处理数组中定义的键(0x01~0x3a)以及alt_right和ctrl_right键,全是make_code */
	       ...
	       (scancode == ctrl_r_make))
    {
	    ...
	    *******************************/
            ...
            }else if (shift_down_last && caps_lock_last) {  // 如果shift和capslock同时按下
	            shift = false;
        ...
        *  之前仅仅把scancode的高字节(即可能是0xe0的字节)设置为0，不影响判断
        */
